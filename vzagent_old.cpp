...
Action act(Game *game, MatchState *state, rng_state_t *rng) {
    ...
    fprintf(stderr, "expected hand strength = %.10lf, relative rank = %.1lf\n", HS, relativeRank);
